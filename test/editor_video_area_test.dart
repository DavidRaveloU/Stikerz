...
void main() {
  testWidgets('EditorVideoArea renders loading spinner and text when not ready', (WidgetTester tester) async {
  ...
  testWidgets('EditorVideoArea shows buffering state UI with progress indicator', (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: SizedBox(
